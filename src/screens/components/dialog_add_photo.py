...
def add_photos_dialog():
    ...
    if 'photo_tab' not in st.session_state:        # ✅ Fixed key name
        st.session_state.photo_tab = 'camera'

    if 'attendance_images' not in st.session_state: # ✅ Safety guard
    ...
    if st.session_state.photo_tab == 'upload':     # ✅ Fixed typo 'uplioad'
